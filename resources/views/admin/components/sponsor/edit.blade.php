    ...
    <div class="row">
        <div class="col-sm-12">
            <section class="card">
                ...
                <div class="card-body">
                    <form class=" form-horizontal" method="POST" action="{{ route('homeslider.update',$slider) }}"
                       ...
                       @method('put')
                        <div class="form-group ">
                            ...
                            <div class="col-lg-10">
                                <input class=" form-control" type="file" id="image" name="homeslider" autofocus>
                            </div>
                            <div class="row">
                                <div class="col-md-3">
                                    <img class="mt-2" src="{{ asset($slider->url) }}" alt="Home slider image" width="100px" height="100px">
                                </div>
                            </div>
                        </div>
